...
@Component
public class PreOrderCancelCalculate extends BaseBookStockCalculate {
	...
	protected SeatsModel generateSeat(BookStockChildModel stock) {
		...
		return seatsAssemble.computeSeatsOnCancelPreOrder(stock.getOldSeats(), stock.getNewSeats());
	}
