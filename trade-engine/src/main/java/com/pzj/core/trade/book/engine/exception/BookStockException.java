...
public class BookStockException extends TradeException {

	final private OccupyStockResponse stockException;

	public BookStockException(final OccupyStockResponse stockE, final int errCode, final String message) {
